...
# All languages
langs = ['ar', 'bn', 'de', 'en', 'es', 'fi', 'fr', 'hi', 'ja', 'ko', 'pt', 'pt-br', 'ru', 'th', 'vi', 'zh']
...
general = {
    'en': {'hero_title': 'Official Store', 'hero_desc': 'Support your learning.', 'category_all': 'All', 'category_clothing': 'Clothing', 'category_accessories': 'Accessories', 'category_digital': 'Digital', 'category_stationery': 'Stationery', 'new_arrival': 'New', 'best_seller': 'Best', 'sold_out': 'Sold Out', 'price_unit': '$', 'add_to_cart': 'Add to Cart', 'buy_now': 'Buy Now', 'option_color': 'Color', 'option_size': 'Size', 'quantity': 'Quantity', 'related_items': 'You Might Also Like', 'back_to_list': 'Back to List'},
    'ko': {'hero_title': '공식 스토어', 'hero_desc': '학습을 응원합니다.', 'category_all': '전체', 'category_clothing': '의류', 'category_accessories': '액세서리', 'category_digital': '디지털', 'category_stationery': '문구', 'new_arrival': '신상품', 'best_seller': '베스트', 'sold_out': '품절', 'price_unit': '$', 'add_to_cart': '장바구니 담기', 'buy_now': '바로 구매', 'option_color': '색상', 'option_size': '사이즈', 'quantity': '수량', 'related_items': '함께 보면 좋은 상품', 'back_to_list': '목록으로 돌아가기'},
    'ja': {'hero_title': '公式ストア', 'category_all': 'すべて', 'category_clothing': '衣類', 'category_accessories': 'アクセサリー', 'category_digital': 'デジタル', 'category_stationery': '文房具', 'new_arrival': '新着', 'best_seller': '人気', 'sold_out': '完売', 'price_unit': '$', 'add_to_cart': 'カートに入れる', 'buy_now': '今すぐ購入', 'option_color': 'カラー', 'option_size': 'サイズ', 'quantity': '数量', 'related_items': 'おすすめ商品', 'back_to_list': '一覧に戻る'},
    'zh': {'hero_title': '官方商店', 'category_all': '全部', 'category_clothing': '服装', 'category_accessories': '配饰', 'category_digital': '数码', 'category_stationery': '文具', 'new_arrival': '新品', 'best_seller': '热销', 'sold_out': '售罄', 'price_unit': '$', 'add_to_cart': '加入购物车', 'buy_now': '立即购买', 'option_color': '颜色', 'option_size': '尺寸', 'quantity': '数量', 'related_items': '猜你喜欢', 'back_to_list': '返回列表'},
    'es': {'hero_title': 'Tienda Oficial', 'category_all': 'Todo', 'category_clothing': 'Ropa', 'category_accessories': 'Accesorios', 'category_digital': 'Digital', 'category_stationery': 'Papelería', 'new_arrival': 'Nuevo', 'best_seller': 'Más Vendido', 'sold_out': 'Agotado', 'price_unit': '$', 'add_to_cart': 'Añadir al Carrito', 'buy_now': 'Comprar Ahora', 'option_color': 'Color', 'option_size': 'Talla', 'quantity': 'Cantidad', 'related_items': 'También te podría gustar', 'back_to_list': 'Volver a la lista'},
    'fr': {'hero_title': 'Boutique', 'category_all': 'Tout', 'category_clothing': 'Vêtements', 'category_accessories': 'Accessoires', 'category_digital': 'Numérique', 'category_stationery': 'Papeterie', 'new_arrival': 'Nouveau', 'best_seller': 'Meilleure Vente', 'sold_out': 'Épuisé', 'price_unit': '$', 'add_to_cart': 'Ajouter au Panier', 'buy_now': 'Acheter Maintenant', 'option_color': 'Couleur', 'option_size': 'Taille', 'quantity': 'Quantité', 'related_items': 'Vous pourriez aussi aimer', 'back_to_list': 'Retour à la liste'},
    'de': {'hero_title': 'Shop', 'category_all': 'Alle', 'category_clothing': 'Kleidung', 'category_accessories': 'Accessoires', 'category_digital': 'Digital', 'category_stationery': 'Schreibwaren', 'new_arrival': 'Neu', 'best_seller': 'Bestseller', 'sold_out': 'Ausverkauft', 'price_unit': '$', 'add_to_cart': 'In den Warenkorb', 'buy_now': 'Jetzt Kaufen', 'option_color': 'Farbe', 'option_size': 'Größe', 'quantity': 'Menge', 'related_items': 'Das könnte Ihnen auch gefallen', 'back_to_list': 'Zurück zur Liste'},
    'ru': {'hero_title': 'Магазин', 'category_all': 'Все', 'category_clothing': 'Одежда', 'category_accessories': 'Аксессуары', 'category_digital': 'Цифровые', 'category_stationery': 'Канцелярия', 'new_arrival': 'Новинка', 'best_seller': 'Хит', 'sold_out': 'Продано', 'price_unit': '$', 'add_to_cart': 'В корзину', 'buy_now': 'Купить сейчас', 'option_color': 'Цвет', 'option_size': 'Размер', 'quantity': 'Количество', 'related_items': 'Вам может понравиться', 'back_to_list': 'Назад к списку'},
    'pt': {'hero_title': 'Loja', 'category_all': 'Tudo', 'category_clothing': 'Roupas', 'category_accessories': 'Acessórios', 'category_digital': 'Digital', 'category_stationery': 'Papelaria', 'new_arrival': 'Novo', 'best_seller': 'Mais Vendido', 'sold_out': 'Esgotado', 'price_unit': '$', 'add_to_cart': 'Adicionar ao Carrinho', 'buy_now': 'Comprar Agora', 'option_color': 'Cor', 'option_size': 'Tamanho', 'quantity': 'Quantidade', 'related_items': 'Você também pode gostar', 'back_to_list': 'Voltar para a lista'},
    'pt-br': {'hero_title': 'Loja', 'category_all': 'Tudo', 'category_clothing': 'Roupas', 'category_accessories': 'Acessórios', 'category_digital': 'Digital', 'category_stationery': 'Papelaria', 'new_arrival': 'Novo', 'best_seller': 'Mais Vendido', 'sold_out': 'Esgotado', 'price_unit': '$', 'add_to_cart': 'Adicionar ao Carrinho', 'buy_now': 'Comprar Agora', 'option_color': 'Cor', 'option_size': 'Tamanho', 'quantity': 'Quantidade', 'related_items': 'Você também pode gostar', 'back_to_list': 'Voltar para a lista'},
    'vi': {'hero_title': 'Cửa hàng', 'category_all': 'Tất cả', 'category_clothing': 'Quần áo', 'category_accessories': 'Phụ kiện', 'category_digital': 'Kỹ thuật số', 'category_stationery': 'Văn phòng phẩm', 'new_arrival': 'Mới', 'best_seller': 'Bán chạy', 'sold_out': 'Hết hàng', 'price_unit': '$', 'add_to_cart': 'Thêm vào giỏ', 'buy_now': 'Mua ngay', 'option_color': 'Màu sắc', 'option_size': 'Kích thước', 'quantity': 'Số lượng', 'related_items': 'Có thể bạn sẽ thích', 'back_to_list': 'Quay lại danh sách'},
    'th': {'hero_title': 'ร้านค้า', 'category_all': 'ทั้งหมด', 'category_clothing': 'เสื้อผ้า', 'category_accessories': 'เครื่องประดับ', 'category_digital': 'ดิจิทัล', 'category_stationery': 'เครื่องเขียน', 'new_arrival': 'ใหม่', 'best_seller': 'ขายดี', 'sold_out': 'หมด', 'price_unit': '$', 'add_to_cart': 'หยิบใส่ตะกร้า', 'buy_now': 'ซื้อเลย', 'option_color': 'สี', 'option_size': 'ขนาด', 'quantity': 'จำนวน', 'related_items': 'คุณอาจชอบสิ่งนี้', 'back_to_list': 'กลับสู่รายการ'},
    'ar': {'hero_title': 'المتجر', 'category_all': 'الكل', 'category_clothing': 'ملابس', 'category_accessories': 'اكسسوارات', 'category_digital': 'رقمي', 'category_stationery': 'قرطاسية', 'new_arrival': 'جديد', 'best_seller': 'الأكثر مبيعاً', 'sold_out': 'نفذت الكمية', 'price_unit': '$', 'add_to_cart': 'أضف إلى السلة', 'buy_now': 'اشتر الآن', 'option_color': 'لون', 'option_size': 'مقاس', 'quantity': 'كمية', 'related_items': 'قد يعجبك أيضاً', 'back_to_list': 'العودة للقائمة'},
    'hi': {'hero_title': 'दुकान', 'category_all': 'सब', 'category_clothing': 'कपड़े', 'category_accessories': 'सामान', 'category_digital': 'डिजिटल', 'category_stationery': 'स्टेशनरी', 'new_arrival': 'नया', 'best_seller': 'सबसे बिकाऊ', 'sold_out': 'बिक गया', 'price_unit': '$', 'add_to_cart': 'कार्ट में जोड़ें', 'buy_now': 'अभी खरीदें', 'option_color': 'रंग', 'option_size': 'आकार', 'quantity': 'मात्रा', 'related_items': 'आपको यह भी पसंद आ सकता है', 'back_to_list': 'सूची पर वापस जाएं'},
    'bn': {'hero_title': 'দোকান', 'category_all': 'সব', 'category_clothing': 'পোশাক', 'category_accessories': 'আনুষাঙ্গিক', 'category_digital': 'ডিজিটাল', 'category_stationery': 'স্টেশনারি', 'new_arrival': 'নতুন', 'best_seller': 'সেরা বিক্রেতা', 'sold_out': 'বিক্রি শেষ', 'price_unit': '$', 'add_to_cart': 'কার্টে যোগ করুন', 'buy_now': 'এখনই কিনুন', 'option_color': 'রঙ', 'option_size': 'আকার', 'quantity': 'পরিমাণ', 'related_items': 'আপনিও পছন্দ করতে পারেন', 'back_to_list': 'তালিকায় ফিরে যান'},
    'fi': {'hero_title': 'Kauppa', 'category_all': 'Kaikki', 'category_clothing': 'Vaatteet', 'category_accessories': 'Asusteet', 'category_digital': 'Digitaalinen', 'category_stationery': 'Paperitarvikkeet', 'new_arrival': 'Uusi', 'best_seller': 'Bestseller', 'sold_out': 'Loppuunmyyty', 'price_unit': '$', 'add_to_cart': 'Lisää ostoskoriin', 'buy_now': 'Osta nyt', 'option_color': 'Väri', 'option_size': 'Koko', 'quantity': 'Määrä', 'related_items': 'Saatat pitää myös', 'back_to_list': 'Takaisin luetteloon'}
}

nav = {
    'en': 'Goods Shop', 'ko': '굿즈샵', 'ja': 'グッズ', 'zh': '周边', 'es': 'Tienda', 'fr': 'Boutique', 
    'de': 'Shop', 'ru': 'Магазин', 'pt': 'Loja', 'pt-br': 'Loja', 'vi': 'Cửa hàng', 'th': 'ร้านค้า',
    'ar': 'المتجر', 'hi': 'दुकान', 'bn': 'দোকান', 'fi': 'Kauppa'
}
...
for lang in langs:
    ...
    if 'nav' not in data:
        data['nav'] = {}
    data['nav']['goods'] = nav.get(lang, nav['en'])
    
    if 'goods' not in data:
        data['goods'] = {}
    
    gen = general.get(lang, general['en'])
    data['goods'].update(gen)
    
    if 'items' not in data['goods']:
        data['goods']['items'] = {}
    
    for item_key, item_trans in items.items():
        data['goods']['items'][item_key] = item_trans.get(lang, item_trans['en'])
