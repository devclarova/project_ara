...
const animSpeedFwd = {
  xs: 'animate-[spin_18s_linear_infinite]',
  sm: 'animate-[spin_15s_linear_infinite]',
  md: 'animate-[spin_12s_linear_infinite]',
  lg: 'animate-[spin_9s_linear_infinite]',
};
