  ...
  return (
    <button
      ...
      className={[
        ...
        'transition-all duration-200 ease-in-out bg-white hover:bg-[#f9f9f9]',
        // selected state (data-variant)
        'data-[selected=true]:bg-[#00BFA5] data-[selected=true]:bg-opacity-20 data-[selected=true]:border-r-[3px] data-[selected=true]:border-r-[#007bff]',
        className,
      ].join(' ')}
    >
