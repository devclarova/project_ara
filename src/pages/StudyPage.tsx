  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="드라마, 예능, 음악 등 K-Contents로 자연스럽게 한국어 표현을 배우는 ARA 학습 페이지입니다."
        />

        <meta property="og:title" content="Study Korean with K-Content | ARA" />
        <meta
          property="og:description"
          content="K-콘텐츠로 재미있게 한국어를 배우고 사용해보세요."
        />
        <meta property="og:image" content="/images/sample_font_logo.png" />
        <meta property="og:url" content="https://project-ara.vercel.app/study" />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://project-ara.vercel.app/study" />
      </Helmet>
