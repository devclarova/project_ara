          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center space-x-2 text-muted-foreground cursor-pointer group">
                <input type="checkbox" className="rounded border-gray-300 dark:border-gray-500 text-primary focus:ring-1 focus:ring-primary/30/30" />
                <span className="group-hover:text-muted-foreground transition-colors">Remember me</span>
              </label>
