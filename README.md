...
> [**`프로젝트 초기 기획, 문제 해결 등 전체 정리 노션 링크`**](https://www.notion.so/Project-ARA-2ad9c06a029480d8a839c51b086ec193?source=copy_link) - 박재현
> [**`프로젝트 초기 기획, 문제 해결 등 전체 정리 노션 링크`**](https://www.notion.so/2ad162532bb4818a8c59f11efaee6045?source=copy_link) - 윤지언
> [**`프로젝트 초기 기획, 문제 해결 등 전체 정리 노션 링크`**]() - 이수하

## 1. 개요

- ARA는 전 세계 사용자가 K-콘텐츠를 통해 자연스럽고 재미있게 한국어를 학습하고,
- SNS를 통해 서로의 문화를 교류하며 성장할 수 있는 플랫폼임
- 한국어(언어)를 단순한 `학습`의 대상이 아닌 `문화와 사람을 연결하는 매개체`로 바라보고
...
- 요약 (상세 내용 참조 ☞ [초기 기획 - 경쟁 서비스 분석 및 차별점](https://www.notion.so/Project-ARA-2ad9c06a029480d8a839c51b086ec193?pvs=21))
  | 항목 | 기존 서비스들 | ARA |
  | ----------- | --------------------- | ------------------------------------------ |
...
| [**`Notion`**](https://www.notion.so/2574c38690cb80648778f10578fa39b2?pvs=21)                                                                                                                          | 일정 관리 및 기획 문서화                   |
...
| **참여 인원**                                                                            | 박재현, 이수하, 윤지언                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **ERD**                                                                                  | [`ERD 다이어그램`](https://drive.google.com/file/d/19cIJgxK4-4BtjvxxHjvlOiJ2hssJZ9R1/view?usp=sharing)                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`노션 링크`](https://www.notion.so/Project-ARA-2ad9c06a029480d8a839c51b086ec193?pvs=21) |
| **API 명세서**                                                                           | [`핵심 기능별 API 명세서`](https://www.notion.so/Project-ARA-2ad9c06a029480d8a839c51b086ec193?pvs=21)                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **발표 자료 및 영상**                                                                    | [`아이디어 발표 자료`](https://www.canva.com/design/DAGwuN-aaqI/jFLt3PIuWfNuylOE1aeX5Q/edit?utm_content=DAGwuN-aaqI&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton) / [`중간 발표 자료`](https://www.canva.com/design/DAG0kNp_uFM/1-dCtbE2Rf0UvdLTcyCTEQ/edit?utm_content=DAG0kNp_uFM&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton) / [`최종 발표 자료`](https://www.canva.com/design/DAG35aMkClc/rRTBUHgJrP38XO-cimhEtw/edit?utm_content=DAG35aMkClc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton) |
| **협업 툴 링크**                                                                         | [\*\*`GitHub`](https://github.com/devclarova/project_ara.git) / [`Notion`](https://www.notion.so/2574c38690cb80648778f10578fa39b2?pvs=21) / [`Slack`](https://scenek.slack.com/docs/T08UZ7TMJP8/F09BT500KQV) / [`Figma`](https://www.figma.com/design/7yRFVNaMCvARrm5UvsGwu4/%ED%8C%80%ED%94%84%EC%A0%9D%ED%8A%B8-%EC%95%84%EB%9D%BC?node-id=2-3244&t=BfS4F9YCfJvddQ1B-1)\*\*                                                                                                                                                                                 |

## 17. 마무리

- ARA는 단순히 한국어를 `가르치는 서비스`가 아님.
- `한국어와 한국 문화의 따뜻함과 아름다움, 그리고 그 속에 담긴 정(情)`과 `사람을 향한 마음`을 전하고
- 동시에 다른 `문화의 다양성과 가치를 존중`하는 `교류의 장`을 만들고자 함
- ARA가 지향하는 진짜 목표는

> “언어는 배우는 것이 아니라, 함께 살아가는 것이다.
> 문화는 이해하는 것이 아니라, 함께 느끼는 것이다.”
