-- [FINAL ENHANCEMENT] Support ALL column filters in get_admin_users_list
DROP FUNCTION IF EXISTS public.get_admin_users_list(int, int, text, text, text, text, text);
DROP FUNCTION IF EXISTS public.get_admin_users_list(int, int, text, text, text, text, text, text);
